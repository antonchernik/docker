...
<br/>* 8.0.0 Dockerfile [(library/php-fpm-xdebug/8.0/ubuntu-amd64/Dockerfile)](https://github.com/antonchernik/docker/blob/php-fpm-xdebug-8.0.0-ubuntu-amd64/library/php-fpm-xdebug/8.0/ubuntu-amd64/Dockerfile)<br />Trivy security report [(library/php-fpm-xdebug/8.0/ubuntu-amd64/trivy.json)](https://github.com/antonchernik/docker/blob/php-fpm-xdebug-8.0.0-ubuntu-amd64/library/php-fpm-xdebug/8.0/ubuntu-amd64/trivy.json)<br />